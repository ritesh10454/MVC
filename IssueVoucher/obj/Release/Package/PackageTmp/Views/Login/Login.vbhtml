        ...
        <div class="col-8">
            <div class ="form-group">
                ...
                <p style="font-family: calibri; font-size: x-large; margin-left: 3%;">
                    <img src="../../Images/people.png" alt="IOLCP" />Simple and Easy to use for Employees
                </p>   
            </div>
            <div class ="form-group">
                    <ul>
            ...
            <div class ="form-group">
                    <p style="font-family: calibri; font-size: x-large; margin-left: 3%;">
                        <img src="../../Images/people.png" alt="IOLCP" />Powerful Monitoring Tool for Managers.
                    </p>
                    <ul>
                    ...
                    <p style="font-family: calibri; font-size: x-large; margin-left: 3%;">
                        <img src="../../Images/people.png" alt="IOLCP">See for Yourself
                        <ul>
