    ...
    <div class ="col-md-12">
        <div class="card card-primary" style="margin-bottom: 5px;">
            <div class="card-header">
                <h3 class="card-title">REPORT CONSUMPTION/COST CENTRE VIZ.</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select id="drpConCen" class ="form-control select2" tabindex ="-1">
                        ...
                        <div class="col-sm-12 col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select id="drpCosCen" class ="form-control select2" tabindex ="-1">
                                            <option value ="L" selected="selected" >--ALL--</option>
                                        </select>
                                    </div>
                                </div>
                     ...
                     <div class="row">
                        <div class="col-12">
                            <div class ="table table-bordered table-striped  dt-responsive" id="mivDetailDIV" >
                                <table id="MIVDetailTable"  border="0" cellpadding="0" cellspacing="0"  class ="table table-striped" style="width:100%;">
                                    <thead>
                                        <tr>
                                            <th>MIV No.</th>
                                            <th>MIV Date</th>
...
@Scripts.Render("~/script/ReportConsCos")
